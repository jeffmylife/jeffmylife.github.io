...
<div style={{padding: '1rem', backgroundColor: '#f3f4f6', borderRadius: '0.5rem', marginBottom: '1rem'}}>
  <strong>Custom styled div</strong> - This is HTML with inline styles!
</div>
...
<div style={{textAlign: 'center', marginTop: '2rem', padding: '1rem', border: '2px dashed #6366f1', borderRadius: '0.5rem'}}>
