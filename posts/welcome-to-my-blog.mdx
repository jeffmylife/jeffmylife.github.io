...
abstract: "A comprehensive showcase of MDX capabilities including syntax highlighting, interactive elements, and custom components for modern blog development."
tags: ["mdx", "react", "nextjs", "markdown", "blog"]
...
<div className="gruvbox-surface">
  <strong className="gruvbox-accent-orange">Custom styled div</strong> - This is HTML using our beautiful Gruvbox theme!
</div>
...
<div className="gruvbox-tip-box">
  🎯 <strong className="gruvbox-accent-primary">Pro Tip:</strong> Start simple with Markdown, then enhance with JSX as needed!
</div>