...
<div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg mb-4">
  <strong>Custom styled div</strong> - This is HTML with Tailwind classes!
</div>
...
<div className="text-center mt-8 p-4 border-2 border-dashed border-blue-500 rounded-lg">
  🎯 <strong>Pro Tip:</strong> Start simple with Markdown, then enhance with JSX as needed!
</div>